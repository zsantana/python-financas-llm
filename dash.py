...
# df["Valor"] = df["Valor"].apply(lambda x: f"{x:.2f}")  # Formata como string
...
fig = px.pie(category_distribution, values='Valor', names='Categoria', title='Distribuição por Categoria', hole=0.4)
